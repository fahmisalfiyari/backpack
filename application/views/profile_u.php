			...
			<div data-v-60934d09="" class="full-width">
				<div data-v-60934d09="" class="rowform-group">
					<div data-v-60934d09="" class="form-group">
						...
						?>
						<?php
							echo "<input data-v-60934d09='' type='text' id='name' name='name' enabled='enabled' value='".$profile->fullname."' aria-describedby='nameHelp' data-vv-as='Full Name' class='form-control' data-vv-id='26' aria-required='true' aria-invalid='false' maxlength='20' onkeypress='return allLetter(event)'>";
						?>
				...
				<div data-v-60934d09="" class="rowform-group">
					<div data-v-60934d09="" class="form-group">
						...
						<?php if($profile->phone){
							...
							echo "<input data-v-60934d09='' type='phone' id='phone' name='phone' enabled='enabled'  placeholder='phone' aria-describedby='phoneHelp' data-vv-as='Phone' class='form-control' data-vv-id='26' aria-required='true' aria-invalid='false' maxlength='12' onkeypress='return hanyaAngka(event)'>";
						}
						?>
